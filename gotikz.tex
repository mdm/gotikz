...
\pgfkeys{%
    ...
    /gotikz/labels/@increment/.initial=true,
...
\def\gotikz@utils@nextletter#1{\expandafter\gotikz@utils@donextletter\expandafter{#1}}
\def\gotikz@utils@donextletter#1{\ifnum`#1=122 \else\Uchar\numexpr`#1+1\relax\fi}
    ...
    {%
        ...
        \pgfkeys{/gotikz/labels/.cd,#1}{%
            ...
            \foreach \ignore in {#2}{%
                ...
                \ifincrementlabel
                    \xdef\gotikz@tmp@label{\gotikz@utils@nextletter\gotikz@tmp@label}
                \fi
            }
        }
    }%
